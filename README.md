...
The **Museum With No Frontiers — Photographs** gallery, built from the published
dataset `@museumwnf/photographs-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/photographs-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/photographs/> through the reusable workflows in
