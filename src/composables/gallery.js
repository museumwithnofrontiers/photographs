...
// `useGalleryData.js` used to be byte-identical local copies of what photographs
...
// legacy project key, no UUID — photographs shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (photographs-data 1.0.11+), an outside
