...
export default {
  ...
  home: {
    title: 'photographs.identity.title',
    intro: 'photographs.home.intro',
    cards: [
      {
        title: 'photographs.nav.catalogue',
        description: 'photographs.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'photographs.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'photographs.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'photographs.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'photographs.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'photographs.partnerObjects.emptyPartner',
  //         emptyInstitution: 'photographs.partnerObjects.emptyInstitution',
  //         institutionSummary: 'photographs.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'photographs.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'photographs.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
